...
var tarteaucitron = {
    ...
    "userInterface": {
        ...
        "color": function (key, status) {
            ...
            if (status === true || tarteaucitron.services[key].needConsent === false) {
            ...
            if (tarteaucitron.services[key].cookies.length > 0 && status === false && tarteaucitron.services[key].needConsent === true) {
        ...
        "number": function () {
            ...
            if (document.cookie !== '') {
                for (i = 0; i < nb; i += 1) {
                    ...
                    html += '    <div class="tarteaucitronCookiesListLeft"><button type="button" class="purgeBtn" data-cookie="' + cookies[i].split('=', 1) + '"><strong>&times;</strong></button> <strong>' + name + '</strong>';
                    html += '    </div>';
